...
- [lmd_classi](https://github.com/matthieuvion/lmd_classi) : Classifier pro-russian comments. From (small) annotated data + baseline w/ few-shot (SetFit) to synthetic data generation, LLM (Mistral-7B or LLama3-8B) fine-tuning and multi-e5-base classifier w/ quantization for deployment (FastAPI/Docker). Full guide, ressources, benchmarks, available as organized notebooks.
